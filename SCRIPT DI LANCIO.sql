...
#ADMIN
insert into amministratore (nome, cognome, email_admin, pwd_admin) values ('admin', 'admin', 'admin@gmail.com', 'admin');
...
insert into azienda (ragione_sociale, indirizzo, partita_iva, codice_fiscale, nome_legale_rappr, cognome_legale_rappr, 
    ...
    'L\'Aquila', 'isweb@email.it', 'isweb001', 'Oggi ISWEB S.p.A. opera nel comparto della ”progettazione e 
...
insert into azienda (ragione_sociale, indirizzo, partita_iva, codice_fiscale, nome_legale_rappr, cognome_legale_rappr, 
    ...
    'Bianchi', 'Giulio', 'Tiscali', '322 0267814', 'giulio.tiscali@email.it', 'Roma', 'engineering@email.it', 'engineering001', 
...
insert into azienda (ragione_sociale, indirizzo, partita_iva, codice_fiscale, nome_legale_rappr, cognome_legale_rappr, 
    ...
    'De Frigis', 'Amleto', 'Acitore', '365 0128794', 'amleto.acitore@email.it', 'Milano', 'aubay@email.it', 'aubay001', 
...
insert into azienda (ragione_sociale, indirizzo, partita_iva, codice_fiscale, nome_legale_rappr, cognome_legale_rappr, 
    ...
    'informetica001', 'InformEtica Consulting è una azienda italiana con un’importante esperienza nell’IT che mette a disposizione 
