...
public class dettaglioOfferta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("titoloOfferta", dettaglioOfferta.getTitolo());
        request.setAttribute("luogo", dettaglioOfferta.getLuogo());
        request.setAttribute("orari", dettaglioOfferta.getOrari());
        request.setAttribute("ore", dettaglioOfferta.getDurata());
        request.setAttribute("obiettivi", dettaglioOfferta.getObiettivi());
