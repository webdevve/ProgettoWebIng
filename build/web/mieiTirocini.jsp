...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <ul class="navbar-nav" style="position: relative; top:8px">
    ...
    <br><br>
            ...
            <label style="position:relative; left:45px"><strong>I miei tirocini</strong></label><br><br>
                ...
                <form action="moreInfo" method="POST">
                    <div class="card" style="width: 60rem;">
                        <div class="card-body">
                            ...
                            <input type="submit"  class="btn btn-primary" value="Dettagli"></button>
                        </div>
                    </div>
