...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Aggiungi Offerta di Tirocinio</title>
        <link rel="stylesheet" href="css/aggiungiOfferta.css" type="text/css"/>
      ...
      <div id="orizzontale">
        <form action="aggiungiOfferta" method="POST">
          ...
          <table>
            ...
            <p class="center"><input type="submit" name="Aggiungi" class="btn btn-primary" id="button" value="Aggiungi"></p>
        </form>
      </div>
    </div>
    </body>
